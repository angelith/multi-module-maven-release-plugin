...
class MultiRepoReleaseInvoker {
	...
	public MultiRepoReleaseInvoker(final Log log, final MavenProject project) {
		this(log, project, new DefaultInvocationRequest(), new DefaultInvoker());
	}

	public MultiRepoReleaseInvoker(final Log log, final MavenProject project, final InvocationRequest request,
	...
	public final void runMavenBuild(final MultiRepoReactor reactor) throws MojoExecutionException {
